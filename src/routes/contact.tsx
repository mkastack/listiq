  ...
  component: () => (
    <SiteShell>
      <section className="mx-auto max-w-4xl px-4 py-20 md:px-6">
        ...
        <h1 className="mt-2 font-display text-4xl font-extrabold tracking-tight md:text-5xl">Let's talk.</h1>
        <p className="mt-3 max-w-xl text-muted-foreground">Questions, partnerships, or feedback — we'd love to hear from you.</p>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={c.label} className="rounded-2xl border border-border bg-card p-6" style={{ boxShadow: "var(--shadow-card)" }}>
