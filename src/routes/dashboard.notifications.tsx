    ...
    <div className="p-4 md:p-8 w-full max-w-4xl mx-auto pb-24 space-y-8 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-sm text-slate-500 font-body-base mt-1">
            Stay updated on your listings, reviews, and account activity.
          </p>
        </div>
        <button
            ...
            >
              ...
              <div className="flex-1 pr-8">
                <div className="flex justify-between items-start mb-1.5">
                  <span
                    className={`text-base font-bold ${n.color === "red" ? "text-red-700" : "text-slate-900"}`}
                  >
                    {n.title}
                  </span>
                ...
                <p className="text-[14px] text-slate-600 leading-relaxed font-medium">{n.text}</p>
      ...
      <div className="mt-20 pt-10 border-t border-slate-100 flex flex-wrap gap-12 justify-center">
        ...
        <div className="text-center">
          ...
          <p className="text-3xl font-bold text-blue-600 font-display">
