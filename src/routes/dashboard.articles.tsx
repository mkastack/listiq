...
function MyArticles() {
  ...
  return (
    <div className="p-4 md:p-8 w-full max-w-7xl mx-auto pb-24 space-y-8 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-sm text-slate-500 font-body-base mt-1">
            Write and manage your business articles
          </p>
        </div>
      ...
      <div
        id="ai-panel"
        className="bg-gradient-to-br from-purple-50 to-white border-2 border-purple-100 rounded-2xl p-6 md:p-8 shadow-sm relative overflow-hidden"
      >
        {isGenerating && (
          <div className="absolute inset-0 bg-white/60 backdrop-blur-sm z-20 flex flex-col items-center justify-center animate-in fade-in duration-300">
            ...
            <p className="text-purple-700 font-bold animate-pulse text-sm">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">
              Instantly create SEO-optimized articles for your listings
            </p>
          </div>
        </div>
              ...
              >
                <option value="">
                  {userListings.length === 0
                    ? "No listings found. Create one first."
                    : "Select a listing..."}
                </option>
                {userListings.map((l) => (
                  ...
                  <tr key={article.id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-5 text-right relative">
                      ...
                      {activeDropdown === article.id && (
                        <div
                          ref={dropdownRef}
                          className="absolute right-6 top-14 w-48 bg-white rounded-xl shadow-xl border border-slate-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200"
                        >
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-20 text-center">
                    ...
                    <p className="text-slate-500 max-w-sm mx-auto">
                      {isLoading
                        ? "Fetching your latest articles..."
                        : "You haven't written any articles yet. Start by generating one with AI or writing a new post!"}
                    </p>
                  </td>
                </tr>
              )}
