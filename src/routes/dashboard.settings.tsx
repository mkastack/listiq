  ...
  return (
    <div className="p-4 md:p-8 w-full max-w-7xl mx-auto pb-24 space-y-8 overflow-hidden">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 font-body-base mt-1">Manage your profile information, security preferences, and notification settings.</p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-8 items-start">
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-8 mb-10">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-slate-500 mt-1">PNG, JPG or GIF. Max size of 1MB.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-widest block">WhatsApp Contact</label>
                  <input
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:bg-white focus:ring-4 focus:ring-blue-600/10 focus:border-blue-600 outline-none font-medium transition-all"
                    type="tel"
                ...
                <div className="col-span-1 md:col-span-2 space-y-2">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-widest block">Professional Bio</label>
                  <textarea
                  ...
                  />
                  <p className="text-right text-[11px] text-slate-400 font-medium italic">{profile.bio.length}/500 characters.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-span-12 lg:col-span-5 space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div className="p-6 border-b border-slate-50">
              <h2 className="text-lg font-bold text-slate-900 flex items-center gap-3">
                <span className="material-symbols-outlined text-blue-600" style={{ fontVariationSettings: "'FILL' 1" }}>security</span> 
                Security
              </h2>
            </div>
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <span className={`inline-block h-5 w-5 transform rounded-full bg-white transition-transform ${twoFactor ? "translate-x-6" : "translate-x-1"}`}></span>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div className="p-6 border-b border-slate-50">
              <h2 className="text-lg font-bold text-slate-900 flex items-center gap-3">
                <span className="material-symbols-outlined text-blue-600" style={{ fontVariationSettings: "'FILL' 1" }}>notifications_active</span>
                Notifications
              </h2>
            </div>
            <div className="p-6 space-y-6">
              <label className="flex items-center justify-between group cursor-pointer">
                <div>
                  <p className="font-bold text-slate-900 group-hover:text-blue-600 transition-colors">Listing Reviews</p>
                  <p className="text-[13px] text-slate-500">Get notified when someone reviews your listing</p>
                </div>
                <input 
                  type="checkbox" 
              ...
              <label className="flex items-center justify-between group cursor-pointer">
                <div>
                  <p className="font-bold text-slate-900 group-hover:text-blue-600 transition-colors">Approvals</p>
                  <p className="text-[13px] text-slate-500">Alerts when your submissions are approved</p>
                </div>
                <input 
                  type="checkbox" 
              ...
              <label className="flex items-center justify-between group cursor-pointer">
                <div>
                  <p className="font-bold text-slate-900 group-hover:text-blue-600 transition-colors">Billing Reports</p>
                  <p className="text-[13px] text-slate-500">Monthly invoice summaries and payment alerts</p>
                </div>
                <input 
                  type="checkbox" 
          ...
          <div className="bg-red-50/50 rounded-2xl border border-red-100 overflow-hidden">
            <div className="p-6 bg-red-100/30 border-b border-red-100">
              <h2 className="text-lg font-bold text-red-700 flex items-center gap-3">
                <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>warning</span> Danger Zone
              </h2>
            </div>
            <div className="p-6">
              <p className="text-sm text-slate-700 mb-6 font-medium">Permanently delete your account and all associated data. This action is irreversible.</p>
              <button onClick={handleDeleteAccount} className="w-full py-3 bg-white border border-red-200 text-red-600 font-bold rounded-xl hover:bg-red-600 hover:text-white hover:border-red-600 transition-all duration-300 shadow-sm">
                Delete Account
              </button>
            </div>
          </div>
